...
const GroupItem = ({ item }) => {
    return (React__default["default"].createElement(React__default["default"].Fragment, null, item.options.length > 0 && (React__default["default"].createElement(React__default["default"].Fragment, null,
        React__default["default"].createElement("div", { className: "pr-2 py-2 cursor-default select-none truncate font-bold text-gray-700 dark:text-gray-300" }, item.label),
...
const SearchInput = React.forwardRef(function SearchInput({ placeholder = "", value = "", onChange, name = "" }, ref) {
    return (React__default["default"].createElement("div", { className: "relative py-1 px-2.5" },
        ...
        React__default["default"].createElement("input", { ref: ref, className: "w-full py-2 pl-8 text-sm text-gray-500 dark:text-gray-300 bg-gray-100 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg focus:border-gray-200 dark:focus:border-gray-500 focus:ring-0 focus:outline-none", type: "text", placeholder: placeholder, value: value, onChange: onChange, name: name })));
});
    ...
    return (React__default["default"].createElement(SelectProvider, { value: value, handleValueChange: handleValueChange },
        React__default["default"].createElement("div", { className: "relative w-full", ref: ref },
            React__default["default"].createElement("div", { "aria-expanded": open, onKeyDown: onPressEnterOrSpace, onClick: toggle, tabIndex: 0, ref: divRef, className: `flex text-base text-gray-500 dark:text-gray-300 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm transition-all duration-300 focus:outline-none ${isDisabled
                ...
                React__default["default"].createElement("div", { className: "absolute inset-0 left-0 right-0 justify-center items-center px-4 flex flex-wrap gap-1" }, !isMultiple ? (React__default["default"].createElement("p", { className: "truncate cursor-default select-none" }, value && !Array.isArray(value) ? value.label : placeholder)) : (React__default["default"].createElement(React__default["default"].Fragment, null,
            ...
            open && !isDisabled && (React__default["default"].createElement("div", { className: "absolute z-10 w-full bg-white dark:bg-gray-800 shadow-lg border dark:border-gray-600 rounded-lg py-1.5 mt-1.5 text-sm text-gray-700 dark:text-gray-300" },
